...
transition_matrix_one <- fucntion(states, pointsScoredRelativeFrequency) {
...
transition_matrix_two <-function(states, ) {
...
#The the relative frequency of each observation in the points scored matrix.
pointsScoredRelativeFrequency <- pointsScoredFrequency / sum(pointsScoredFrequency)

transitionMatrixOne <- transition_matrix_one(states, pointsScoredRelativeFrequency)
