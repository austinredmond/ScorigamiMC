...
#### The Points Scored Distributions
...
po#Save the individual points scored matrix to file.
...
for(t in 0:124) {
  ties[[length(ties)+1]] <- paste(t,t,sep = "-")
}

tiedScorigamiStates <- intersect(scorigamiStates, ties)
nonTieScorigamiStates <- setdiff(scorigamiStates, tiedScorigamiStates)


save(scorigamiStates, file="scorigamiStates.Rda")

load("scorigamiStates.Rda")
