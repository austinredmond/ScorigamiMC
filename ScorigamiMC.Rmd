...
combined_frequency <- function(pointsScoredObservations) {
  x <- c(pointsScoredObservations$losing_team_points_scored, pointsScoredObservations$winning_team_points_scored)
  combined_frequency <- vector(mode="numeric", length = length())
  for(i in 1:length(x)) {
...
combined_frequency(pointsScoredObservations)
x <- table(c(pointsScoredObservations$losing_team_points_scored, pointsScoredObservations$winning_team_points_scored))
View(x)
```
