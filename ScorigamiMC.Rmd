...
points_scored_frequency <- function(gameData){
  ...
  pointsScoredFrequency <- matrix(rep(0, 35*35), nrow = 35, ncol=35)
  rownames(pointsScoredFrequency) <- 0:34
  colnames(pointsScoredFrequency) <- 0:34
...
points_scored_observations <- function(pointsScoredFrequency) {
  ...
  for(c in as.character(0:34)) {
    for(r in as.character(0:34)) {
